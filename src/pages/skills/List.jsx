...
const List = () => {
    ...
    const getSkills = async () => {
        try {
            ...
            const response = await ApiService.request({
                method: "GET",
                url: "skills", // Replace with your API endpoint
                data: apiData
            });
    ...
    const updateStatus = async (id) => {
        ...
        if (result.isConfirmed) {
            const response = await ApiService.request({
                method: "POST",
                url: `skills/status/${id}`, // Replace with your API endpoint
            });
            const data = response.data;
            if (data.status) {
                getSkills();
                ...
                <div id="kt_app_toolbar_container" className="app-container container-xxl d-flex flex-stack">
                    <div className="page-title d-flex flex-column justify-content-center flex-wrap me-3">
                        ...
                        <ul className="breadcrumb breadcrumb-separatorless fw-semibold fs-7 my-0 pt-1">
                            ...
                            <li className="breadcrumb-item text-muted">Skills</li>
                        </ul>
                    </div>
                    <div className="d-flex align-skills-center gap-2 gap-lg-3">
                        {/* Add New skills Button */}
                        <Link to={`/skills/create`}  className='btn btn-base btn-sm'>{("Add New Skill")}</Link>
                    </div>
                </div>
            </div>
                ...
                <div id="kt_app_content_container" className="app-container container-xxl">
                    <div className="card">
                                ...
                                <form method="get">
                                    <div className="row">
                                        <div className="col-md-4">
                                            <div className="d-flex align-skills-center position-relative my-1">
                        ...
                        <div className="card-body pt-0">
                            <div id="kt_skills_table_wrapper" className="dataTables_wrapper dt-bootstrap4 no-footer">
                                <div className="table-responsive">
                                    <table className="table align-middle table-hover fs-6 gy-5 dataTable no-footer">
                                        ...
                                        <tbody className="fw-semibold text-gray-600 fs-6">
                                            {skills.length > 0 ? skills.map((cat, index) => (
                                                <tr key={index}>
                                                    {/* <td>
                                                    ...
                                                    <td className="mt-2">
                                                        <Link to={`/skills/create/${cat._id}`} className="btn btn-sm h-35px btn-light-primary">
