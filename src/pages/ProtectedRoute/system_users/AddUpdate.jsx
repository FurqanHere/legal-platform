        ...
        <div id="kt_app_toolbar_container" className="app-container container-xxl d-flex flex-stack">
          <div className="page-title d-flex flex-column justify-content-center flex-wrap me-3">
            ...
            <ul className="breadcrumb breadcrumb-separatorless fw-semibold fs-7 my-0 pt-1">
              ...
              <li className="breadcrumb-item text-muted">
                <Link to="/auctions" className="text-muted text-hover-primary">{('System Users')} </Link>
              </li>
            </ul>
          </div>
        </div>
              ...
              <form onSubmit={handleSubmit} className="form fv-plugins-bootstrap5 fv-plugins-framework">
                <div className="row g-9 my-3">
                  ...
                  <div className="col-md-6 fv-row fv-plugins-icon-container">
                    ...
                    <select value={formData.role_id} name='role_id' onChange={handleChange} className='form-select'>
                  ...
                  <div className="col-md-6 fv-row fv-plugins-icon-container">
                    <label className="required fs-6 fw-semibold mb-2"> {('Branch')}</label>
                      <MultiSelect
                        ...
                        optionLabel="name"
                        optionValue="_id"
                        onChange={(e) => setFormData({ ...formData, branches: e.value })}
                  ...
                  <div className="col-md-6 fv-row fv-plugins-icon-container">
                    ...
                    <select value={formData.status} name='status' onChange={handleChange} className='form-select'>
                  ...
                  <div className="col-md-6 fv-row fv-plugins-icon-container">
                    <label className="fs-6 fw-semibold mb-2"> {('Profile Picture')}</label>
                    <input
                      type="file"
                      className="form-control form-control-solid"
                      accept="image/*"
                ...
                <div className="row g-9 my-3">
                  <div className="text-center">
                    <Link to="/system-users" className="btn btn-light me-3">Back</Link>
